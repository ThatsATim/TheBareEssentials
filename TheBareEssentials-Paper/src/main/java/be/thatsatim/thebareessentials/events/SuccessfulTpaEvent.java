package be.thatsatim.thebareessentials.events;

/*
 *  Credit for this code belongs to: TheDutchMC
 * https://github.com/TobiasDeBruijn/DutchyTPA/blob/master/src/main/java/nl/thedutchmc/dutchytpa/SuccessfulTpaEvent.java
 * */
